...
mon swdp_scan
attach 1
        python-version: # GDB/Python functions for dealing with NuttX
...
.        Prints performance counters.
      ...
      run: # copy the file to .gdbinit in your Firmware tree, and adjust the path
...
Dumps the STM32F4 memory to files in /tmp/dump.
      ...
      run: # program a bootable device load on a mavstation
...
$opener $graphfile
      with: # The latest defaults in OpenOCD 0.7.0 are actually prettymuch correct for the px4fmu
