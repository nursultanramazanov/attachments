...
class m150924_202359_drop_table_attr_variant extends CDbMigration
{
  ...
  CARGO_TERM_COLOR: This file is automatically generated by conda-smithy. If any
...
- - python
  - numpy  
    ...
    steps: setlocal EnableDelayedExpansion
@echo on
...
https://docs.github.com/en/actions/reference/encrypted-secrets  
      run: # This file defines the configuration for building conda packages with CI.
