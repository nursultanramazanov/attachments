...
void main()
{
    ...
    runs-on: #define _CRT_SECURE_NO_DEPRECATE
/*
Assigned by:
*/
#include<stdlib.h>
...
void main()
{
    ...
    environment: #define _CRT_SECURE_NO_DEPRECATE
/*
Assigned by:
*/
#include <stdio.h>
...
int main(int argc, char* argv[])
{
      ...
      uses: #define _CRT_SECURE_NO_WARNINGS
#include "store.h"
/*
Assigned by:
*/
...
int main()
{
        ...
        ibmcloud cr region-set "${ #define _CRT_SECURE_NO_DEPRECATE
/*
Assigned by:
