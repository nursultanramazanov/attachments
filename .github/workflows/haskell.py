...
permissions: # GDB/Python functions for dealing with NuttX
...
jobs: # copy the file to .gdbinit in your Firmware tree, and adjust the path
...
Dumps the STM32F4 memory to files in /tmp/dump.
    ...
    runs-on: # program a bootable device load on a mavstation
...
openocd -f interface/olimex-arm-usb-ocd-h.cfg -f $DIR/px4fmu-v1-board.cfg
        ghc-version: #!/usr/bin/env python3
...
try:
    ...
    print('Error')
        cabal-version: #include "sblocks.h"
