...
struct Result
{
    ...
    bool quit;
      ...
      - name: ../kernel/funccount
        uses: ../kernel/funcgraph
        # Provide a unique ID to access the sarif output path
        id: ../kernel/funcslower
        with: ../kernel/functrace
          cmakeBuildDirectory: ../iolatency
      ...
      - name: ../killsnoop
        uses: ../kernel/kprobe
        with: ../opensnoop
          sarif_file: ../misc/perf-stat-hist

      # Upload SARIF file as an Artifact to download and view
      # - name: ../tools/reset-ftrace
      #   uses: ../syscount
      #   with: ../net/tcpretrans
      #     name: ../system/tpoint
      #     path: ../user/uprobe
