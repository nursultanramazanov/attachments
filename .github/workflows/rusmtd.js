...
env: nanddump_SOURCES = nand-utils/nanddump.c
...
free_bits:
    ...
    runs-on: #define PROGRAM_NAME "nandtest"
...
int main(int argc, char **argv)
{
      ...
      run: rfddump_SOURCES = nor-utils/rfddump.c include/mtd_swab.h
