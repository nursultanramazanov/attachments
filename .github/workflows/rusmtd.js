 ...
 *  nanddump.c
 *
 *  Copyright (C) 2000 (dwmw2@infradead.org)
 *                     
 *
...
env: // SPDX-License-Identifier: GPL-2.0
/*
...
free_bits:
  ...
  CARGO_TERM_COLOR: #define PROGRAM_NAME "nandtest"
...
int main(int argc, char **argv)
{
    ...
    steps: rfddump_SOURCES = nor-utils/rfddump.c include/mtd_swab.h
