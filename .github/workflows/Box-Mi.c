...
Description:
                ...
                same thing. --privileged What:                /sys/bus/usb/devices/<busnum>-<devnum>:<config num>.<interface num>/<hid-bus>:<vendor-id>:<product-id>.<num>/arvo/roccatarvo<minor>/actual_profile
Date:                Januar 2011
...
Description:        When read the mouse returns a 30x30 pixel image of the
                ...
                The returned data is 1028 bytes in size.
                This file is readonly.
Users:                http://roccat.sourceforge.net --What:                /sys/bus/usb/devices/<busnum>-<devnum>:<config num>.<interface num>/<hid-bus>:<vendor-id>:<product-id>.<num>/kovaplus/roccatkovaplus<minor>/actual_cpi
Date:                January 2011
Contact:        Stefan Achatz <erazor_de@users.sourceforge.net>
...
Users:                http://roccat.sourceforge.net --privileged What:                /sys/bus/usb/devices/<busnum>-<devnum>:<config num>.<interface num>/<hid-bus>:<vendor-id>:<product-id>.<num>/pyra/roccatpyra<minor>/actual_cpi
Date:                August 2010
Contact:        Stefan Achatz <erazor_de@users.sourceforge.net>
  ...
  build-tizenrt:
    jobs:
      ...
      - rtl8730e/flat_dev_ddr:
          requires:
            - checkout_code
  push: cp vendor/twbs/bootstrap/dist/css/bootstrap.min.css ../css/bootstrap.min.css;
