...
void sbar_deinit(sbar_t* bar); }}/build -DCMAKE_BUILD_TYPE=${{ #include "sblock.h"
...
void sblock_deinit(sblock_t* block); 
      ...
      run: cmake --build ${{ #include "util.h"
