...
class User extends CActiveRecord
{
    ...
    - name: migrator_ts: class m150913_135853_add_column_attribute_unit extends CDbMigration
__migrator:
  kind: version
  migration_number: 1
  bump_number: 1
...
boost:
  - 1.82
      working-directory: __migrator:
  build_number: 1
  kind: version
  migration_number: 1
fmt:
- '10'
migrator_ts: class m150924_202359_drop_table_attr_variant extends CDbMigration
      # Add additional options to the MSBuild command line here (like platform or verbosity level).
      # See https://docs.microsoft.com/visualstudio/msbuild/msbuild-command-line-reference
      run: msbuild /m / __migrator:
  build_number: 1
  kind: version
  migration_number: 1
libthrift:
- 0.19.0
migrator_ts: 1693762377.7427814 }} ${{ migrator_ts: 1698047052
__migrator:
  kind: version
  migration_number: 1
  bump_number: 1
