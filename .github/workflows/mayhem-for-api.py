...
.        Prints performance counters.
    ...
    name: # copy the file to .gdbinit in your Firmware tree, and adjust the path
...
$opener $graphfile
      security-events: # The latest defaults in OpenOCD 0.7.0 are actually prettymuch correct for the px4fmu
